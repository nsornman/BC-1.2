    ...
    <table class = "Report-box">
        ...
        <tbody>
            <?php 
                ...
                //                 $imageHtml .= '<img src="Report_pic/' . $md . '/'. $row['case_id'] .'/' . htmlspecialchars($img) . '" alt="Problem Image" style="max-width: 300px; border-radius: 8px; margin: 5px;">';                        
                //             }
        ...
        echo "</tr>";
            ...
            // เพิ่มการสนับสนุน touch/swipe สำหรับมือถือ
            document.addEventListener('DOMContentLoaded', function() {
